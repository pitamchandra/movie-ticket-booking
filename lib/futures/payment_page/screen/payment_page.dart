...
import '../../ticket/screens/ticket_page.dart';
 ...
 const PaymentPage({
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CustomButton(buttonText: "Continue", color: Colors.amber, onPressed: (){goToTriketPage();}, textColor: Colors.black),
    );
  }
  void goToTriketPage(){
